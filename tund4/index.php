<?php
	...
	$monthNamesEST = ["Jaanuar", "Veebruar", "Märts", "Aprill", "Mai", "Juuni", "Juuli", "August", "September", "Oktoober", "November", "Detsember"];
	//var_dump ($monthNow);
	//echo $monthNamesEST[0];
	//var_dump ($weekDayNow);
...
<body>
	...
	<?php
		echo "<p> Täna on ".$weekDayNamesEST[$weekDayNow - 1]. ", " .$dayNow . ". ".$monthNamesEST[$monthNow - 1]. " " .$yearNow. "</p> \n";
